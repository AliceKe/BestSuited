...
function CustomToggle({ eventKey, setExpandTextSearch }) {
  ...
  return (
    <Button
      className="rounded-end-pill pt-1 ms-3 mb-1 w-100 h-100"
      variant="warning"
...
const AccordionSection = ({
  ...
  return (
    <Accordion
      ...
      className="w-75 mx-auto d-flex justify-content-center align-items-center flex-column mt-3"
    >
