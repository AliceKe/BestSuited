...
def navigate_to_reviews():
    ...
    reviews_cell = browser.find_element(By.CSS_SELECTOR, 'a[data-test="ei-nav-reviews-link"]')
...
def sign_in():
    ...
    continue_button = browser.find_element(By.XPATH, '//button[@type="submit"]')
    continue_button.click()
    time.sleep(3)
    password_field = browser.find_element(By.ID, 'inlineUserPassword')
